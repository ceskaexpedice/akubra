...
import static org.ceskaexpedice.akubra.conf.Constants.WORKING_DIR;
...
public class Configuration {
    ...
    public static final java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger(Configuration.class.getName());
    ...
    private static Configuration _sharedInstance = null;
    ...
    public synchronized static Configuration getInstance() {
        if (_sharedInstance == null) {
            ...
            _sharedInstance = new Configuration(workingDir);
        }
        return _sharedInstance;
    }


    private org.apache.commons.configuration.Configuration allConfigurations;
    private String configDir = null;

    protected Configuration(String configDir) {
...
//    private org.apache.commons.configuration.Configuration findAllConfigurations() throws IOException {
...
*/
    public String getSolrProcessingHost() {
        // TODO return getProperty("solrProcessingHost");

        // TODO
        String processingSolrHost = "http://localhost:8983/solr/processing";
        return processingSolrHost;
    }
    ...
    public String getProperty(String key) {
        ...
        if(key.equals("objectStore.path")) {
            return "c:\\Users\\petr\\.kramerius4\\data\\objectStore";
        }else if(key.equals("objectStore.pattern")) {
            return "##/##";
        }else if(key.equals("datastreamStore.path")) {
            return "c:\\Users\\petr\\.kramerius4\\data\\datastreamStore";
        }else if(key.equals("datastreamStore.pattern")) {
            return "##/##";
        }
...
*/
    public int getCacheTimeToLiveExpiration() {
        return 60;
        // TODO return getConfiguration().getInt("cache.timeToLiveExpiration", 60);
    }
