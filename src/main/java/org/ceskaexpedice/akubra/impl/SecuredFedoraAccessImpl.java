...
import org.ceskaexpedice.akubra.fedora.RepositoryAccess;
import org.ceskaexpedice.akubra.fedora.om.repository.AkubraRepository;
import org.ceskaexpedice.akubra.fedora.om.repository.RepositoryException;
import org.ceskaexpedice.akubra.fedora.om.resourceindex.IResourceIndex;
import org.ceskaexpedice.akubra.fedora.om.resourceindex.ResourceIndexException;
import org.ceskaexpedice.akubra.fedora.utils.FedoraUtils;
import org.ceskaexpedice.akubra.imaging.DiscStrucutreForStore;
import org.ceskaexpedice.akubra.security.RightsResolver;
import org.ceskaexpedice.akubra.security.SecuredActions;
import org.ceskaexpedice.akubra.security.SecurityException;
...
public class SecuredFedoraAccessImpl implements RepositoryAccess {
    ...
    public InputStream getImageFULL(String pid) throws IOException {
        ...
        throw new org.ceskaexpedice.akubra.security.SecurityException(new org.ceskaexpedice.akubra.security.SecurityException.SecurityExceptionInfo(SecuredActions.A_READ, pid, FedoraUtils.IMG_FULL_STREAM));
    }
    ...
    public InputStream getFoxml(String pid, boolean archive) throws IOException {
        ...
        throw new org.ceskaexpedice.akubra.security.SecurityException(new org.ceskaexpedice.akubra.security.SecurityException.SecurityExceptionInfo(SecuredActions.A_READ, pid, null));
    }
    ...
    public InputStream getDataStream(String pid, String datastreamName) throws IOException {
        if (isDefaultSecuredStream(datastreamName)) {
            ...
            throw new org.ceskaexpedice.akubra.security.SecurityException(new org.ceskaexpedice.akubra.security.SecurityException.SecurityExceptionInfo(SecuredActions.A_READ, pid, datastreamName));
        } else {
    ...
    public InputStream getFullThumbnail(String pid) throws IOException {
        ...
        if (accessed) {
            ...
            throw new org.ceskaexpedice.akubra.security.SecurityException(new SecurityException.SecurityExceptionInfo(SecuredActions.A_READ, pid, FedoraUtils.IMG_PREVIEW_STREAM));
        }
    }
